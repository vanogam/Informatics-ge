...
public class CppExecutor implements Executor {
    ...
    private static final String MEMORY_KEY = "Maximum resident set size (kbytes)";
    ...
    public void evaluate(DockerClient client, String containerId, TestResult.Builder builder) throws InterruptedException {
        Utils.CommandResult result = executeCommandSync(
                client,
                containerId,
